...
# Read two images
image1 = cv2.imread('Class_Q2/img1.jpg')
image2 = cv2.imread('Class_Q2/img2.jpg')
...
# Save the pyramids
for i in range(3):
    cv2.imwrite(f'Class_Q2/gauss1_{i}.jpg', gauss1[i])
    cv2.imwrite(f'Class_Q2/lapl1_{i}.jpg', lapl1[i])
    cv2.imwrite(f'Class_Q2/gauss2_{i}.jpg', gauss2[i])
    cv2.imwrite(f'Class_Q2/lapl2_{i}.jpg', lapl2[i])
