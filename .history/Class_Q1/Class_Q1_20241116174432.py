...
def analyze_image(image_path):
    ...
    I1_permuted = I1.flatten()
    np.random.shuffle(I1_permuted)
    I1_permuted = I1_permuted.reshape(I1.shape)
    ...
    def calculate_mutual_information(image):
        left_neighbors = np.roll(image, shift=1, axis=1)  # Shift left by 1
...
# Example usage
def main():
    analyze_image("C:\Git Clones\Image_Processing_Course\Class_Q1\Q1_Image.jpg")
